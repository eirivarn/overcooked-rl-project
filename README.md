...
This project is based on [Overcooked-AI](https://github.com/HumanCompatibleAI/overcooked_ai), 
developed by [HumanCompatibleAI](https://humancompatible.ai/).  
The environment and base code were adapted for academic purposes as part of the "Autonomous and Adaptive Systems" course at UNIBO.
